...
class PetFriends:
    ...
    def get_API_key(self, email: str, passwd: str) -> json:
        ...
        с уникальным ключем я пользователя с указанным email и паролем"""
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        """Метод делает запрос к API сервера и возвращает статус запроса и результат в формате JSON
        со списком наденных питомцев, совпадающих с фильтром. На данный момент фильтр может иметь либо
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str, animal_type: str, age: "") -> json:
    ...
    def create_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str, age: int) -> json:
        """Метод отправляет на сервер данные о новом питомце и возвращает статус запроса на сервер и
        результат в формате JSON с данными созданного питомца"""
